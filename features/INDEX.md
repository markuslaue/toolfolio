...
| ID | Feature | Prio | Abhaengig von | Status |
|----|---------|------|---------------|--------|
| S-01 | Login (E-Mail/Passwort + Google-SSO, optional 2FA), etabliert die Auth-Huelle | P0 | INFRA-1 | In Progress (Backend fertig, QA offen, PRJ-02) |
...
| B-17 | Berichte / Weiterverrechnungs-Report | P1 | B-09 | Roadmap |
...
| B-22 | Team / Wer-nutzt-was (Offboarding) | P2 | B-30 | Roadmap |
...
| B-30 | Einstellungen - Team & Rollen | P1 | B-26 | Roadmap |
| B-31 | Einstellungen - Daten & Datenschutz | P1 | B-26 | Roadmap |
...
| ID | Feature | Prio | Abhaengig von | Status |
|----|---------|------|---------------|--------|
| E-01 | Willkommen | P1 | S-02 | Roadmap |
...
| E-06 | Wochen-/Monatsreport | P1 | B-17 | Roadmap |
