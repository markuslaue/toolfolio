...
const mockTreffer: Treffer[] = [
  ...
  { id: "t2", tool: "Ahrefs", initial: "A", farbe: "#0F66F0", buchungstext: "PADDLE.NET* AHREFS PRO", betrag: 99, intervall: "monatlich", letzteAbbuchung: "2026-06-09", kategorie: "SEO", kanal: kanaele[0], konfidenz: "hoch", imVerzeichnis: true, aktiv: true, kunde: "Kunde Vitalplant" },
  ...
  { id: "t6", tool: "Anthropic API", initial: "A", farbe: "#D4A27F", buchungstext: "ANTHROPIC PBC", betrag: 42.18, intervall: "monatlich", letzteAbbuchung: "2026-06-02", kategorie: "KI / API", kanal: kanaele[1], konfidenz: "hoch", imVerzeichnis: true, aktiv: true, kunde: "Kunde FULEX" },
  ...
  { id: "t10", tool: "Vercel", initial: "V", farbe: "#000000", buchungstext: "VERCEL INC", betrag: 20, intervall: "monatlich", letzteAbbuchung: "2026-06-13", kategorie: "Entwicklung", kanal: kanaele[1], konfidenz: "hoch", imVerzeichnis: true, aktiv: true, kunde: "Kunde ZAQQ" },
  ...
  { id: "t18", tool: "Typeform", initial: "T", farbe: "#262627", buchungstext: "TYPEFORM SL BARCELONA", betrag: 35, intervall: "monatlich", letzteAbbuchung: "2026-06-22", kategorie: "Produktivität", kanal: kanaele[0], konfidenz: "dublette", imVerzeichnis: true, aktiv: false, kunde: "Kunde Vitalplant" },
];
