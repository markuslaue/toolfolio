...
const mockTreffer: Treffer[] = [
  ...
  { id: "t6", tool: "Anthropic API", initial: "A", farbe: "#D4A27F", buchungstext: "ANTHROPIC PBC", betrag: 42.18, intervall: "monatlich", letzteAbbuchung: "2026-06-02", kategorie: "KI / API", kanal: kanaele[1], konfidenz: "hoch", imVerzeichnis: true, aktiv: true, kunde: "Kunde Kessler" },
