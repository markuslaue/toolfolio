...
type Block = {
  ...
  title: string;
  desc: string;
  /** Feature existiert noch nicht. Wird als "in Vorbereitung" gekennzeichnet, statt
      ein Versprechen zu machen, das der Nutzer nach der Anmeldung nicht einloesen kann. */
  bald?: boolean;
...
const blocks: Block[] = [
  ...
  { id: "benchmark", icon: BarChart3, eyebrow: "Sieh, ob du zu viel zahlst", painpoint: "Du zahlst für gleiche Leistung mehr als nötig, weißt es aber nicht.", title: "Benchmark aus echten, anonymisierten Abrechnungsdaten.", bald: true, desc: "Wir werden deine Preise mit dem Median vergleichbarer Betriebe vergleichen, damit du erkennst, wo du zu viel zahlst. Das setzt genug anonymisierte Abrechnungsdaten voraus, und die entstehen erst mit den ersten Nutzern. Wir bauen es, sobald die Datenbasis trägt.", shots: [{ slot: "Benchmark-Ansicht Du gegen Markt-Median.", caption: "benchmark", Preview: PreviewBenchmark }] },
