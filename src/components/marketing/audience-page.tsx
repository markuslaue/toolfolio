...
function FaqItem({ q, a }: Faq) {
  ...
  return (
    <div className="rounded-3xl border border-[#1F1D2B]/10 bg-white p-5 shadow-[0_8px_28px_-18px_rgba(31,29,43,0.25)]">
      ...
      {open && (
        <p className="mt-3 text-[15px] leading-relaxed text-[#1F1D2B]/75">{a}</p>
      )}
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#FBF7F1] text-[#1F1D2B]">
      ...
      <header className="mx-auto max-w-7xl px-6 pb-16 pt-8">
        <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_1fr]">
          <Reveal>
            ...
            <p className="mt-5 max-w-xl text-lg leading-relaxed text-[#1F1D2B]/75">
              {data.subline}
            </p>
            ...
            <p className="mt-4 text-xs text-[#1F1D2B]/55">
              14 Tage voller Agentur-Zugang, danach Plan wählen oder Free. Keine Kreditkarte.
            </p>
          </Reveal>
          ...
          {data.pains.map((p, i) => (
            <Reveal key={p.title} delay={i * 80}>
              <div className="h-full rounded-3xl border border-[#1F1D2B]/10 bg-white p-6 shadow-[0_8px_30px_-18px_rgba(31,29,43,0.25)] transition hover:-translate-y-1">
                <div className="font-display text-lg font-semibold text-[#1F1D2B]">
                  {p.title}
                </div>
                <p className="mt-2 text-sm leading-relaxed text-[#1F1D2B]/70">
                  {p.body}
                </p>
              </div>
            </Reveal>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          <Reveal>
            ...
            <h2 className="mt-3 max-w-3xl font-display text-4xl font-bold leading-tight sm:text-5xl">
              Das brauchst du wirklich als {data.segmentLabel}.
            </h2>
          </Reveal>
              ...
              return (
                ...
                >
                  <Reveal className={reverse ? "lg:order-2" : ""}>
                    ...
                    <p className="mt-4 text-[17px] leading-relaxed text-[#1F1D2B]/75">
                      {f.body}
                    </p>
                    ...
                    {f.href && (
                      <Link
                        to={f.href}
                        className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-[#6C5CE7] hover:gap-2.5 transition-all"
                      >
      ...
      <section className="mx-auto max-w-7xl px-6 py-24">
        <Reveal>
          ...
          <h2 className="mt-3 max-w-3xl font-display text-4xl font-bold leading-tight sm:text-5xl">
            Konkret weniger Chaos, mehr Marge.
          </h2>
          <p className="mt-4 max-w-3xl text-lg leading-relaxed text-[#1F1D2B]/75">
            {data.outcomeBody}
          </p>
          ...
          {data.outcomes.map((o, i) => (
            <Reveal key={o.label} delay={i * 80}>
              <div className="rounded-3xl border border-[#1F1D2B]/10 bg-white p-7 text-center shadow-[0_8px_30px_-18px_rgba(31,29,43,0.25)]">
                <div className="font-display text-4xl font-extrabold text-[#6C5CE7] tabular-nums">
                  {o.kpi}
                </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[1.4fr_1fr] lg:items-center">
              <div>
                ...
                <h2 className="mt-3 font-display text-4xl font-bold leading-tight sm:text-5xl">
                  {data.planName} für {data.segmentLabel}
                </h2>
              ...
              <div className="rounded-3xl bg-white/10 p-6 backdrop-blur">
                ...
                <Link
                  to="/preise"
                  className="mt-5 inline-flex w-full items-center justify-center gap-2 rounded-full bg-white px-5 py-3 text-sm font-semibold text-[#6C5CE7] transition hover:-translate-y-0.5"
                >
      ...
      <section className="bg-white py-24">
        <div className="mx-auto max-w-7xl px-6">
          <Reveal>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#FF7A66]">
              Stimmen aus dem Segment
            </p>
            <h2 className="mt-3 max-w-3xl font-display text-4xl font-bold leading-tight sm:text-5xl">
              Was {data.segmentLabel} sagen.
            </h2>
            <p className="mt-2 text-sm text-[#1F1D2B]/55">
              Platzhalter-Zitate, werden mit echten Stimmen ersetzt.
            </p>
          </Reveal>
            ...
            {data.voices.map((v, i) => (
              <Reveal key={v.name} delay={i * 80}>
                <div className="h-full rounded-3xl border border-[#1F1D2B]/10 bg-[#FBF7F1] p-6">
                  ...
                  <p className="mt-3 text-[15px] leading-relaxed text-[#1F1D2B]/85">
                    „{v.quote}"
                  </p>
      ...
      <section className="mx-auto max-w-4xl px-6 py-24">
        <Reveal>
          ...
          <h2 className="mt-3 font-display text-4xl font-bold leading-tight sm:text-5xl">
            Antworten für {data.segmentLabel}.
          </h2>
        </Reveal>
        ...
        <div className="mt-6 grid gap-5 md:grid-cols-2">
          {data.otherAudiences.map((o) => (
            <Link
              ...
              to="/fuer/$slug"
              params={{ slug: o.slug }}
              className="group rounded-3xl border border-[#1F1D2B]/10 bg-white p-6 transition hover:-translate-y-1 hover:border-[#6C5CE7]/40"
            >
        ...
        <Reveal>
          <div className="rounded-[2rem] bg-[#1F1D2B] p-12 text-center text-white">
            <h2 className="font-display text-4xl font-bold leading-tight sm:text-5xl">
              Bereit, deine Toolkosten in den Griff zu bekommen?
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-white/75">
              14 Tage voller Zugang. Keine Kreditkarte. Jederzeit kündbar.
            </p>
            <Link
              to="/dashboard"
...
/* ---------- Mini-Previews for slots without dedicated component ---------- */
  ...
  return (
    <div className="h-full w-full bg-white p-5 text-[#1F1D2B]" style={{ fontVariantNumeric: "tabular-nums" }}>
      <div className="flex items-center justify-between">
        ...
        <div className="rounded-full bg-[#12B76A]/15 px-2 py-0.5 text-[10px] font-semibold text-[#12B76A]">
          Bereit zum Versand
        </div>
      </div>
      <div className="mt-4 space-y-2 text-[12px]">
        {[
          ["Nordwerk Studio", "1.249,00 €", "+18% Marge"],
          ["Kessler", "684,00 €", "+22% Marge"],
          ["Solea", "412,00 €", "+15% Marge"],
          ["Atelier Norden", "298,00 €", "+12% Marge"],
        ].map(([k, v, m]) => (
  ...
  return (
    <div className="h-full w-full bg-white p-5 text-[#1F1D2B]" style={{ fontVariantNumeric: "tabular-nums" }}>
      ...
      <div className="mt-3 grid grid-cols-3 gap-2 text-[11px]">
        <div className="rounded-xl border border-[#1F1D2B]/10 p-3">
          <div className="text-[#1F1D2B]/60">Bezahlte Seats</div>
          <div className="mt-1 font-display text-xl font-extrabold">24</div>
        </div>
        <div className="rounded-xl border border-[#F5A623]/40 bg-[#F5A623]/10 p-3">
          <div className="text-[#1F1D2B]/60">Ungenutzt</div>
          <div className="mt-1 font-display text-xl font-extrabold text-[#F5A623]">7</div>
        </div>
        <div className="rounded-xl border border-[#12B76A]/40 bg-[#12B76A]/10 p-3">
          <div className="text-[#1F1D2B]/60">Sparpotenzial</div>
          <div className="mt-1 font-display text-xl font-extrabold text-[#12B76A]">189 €</div>
        </div>
      </div>
      <div className="mt-4 space-y-1.5 text-[12px]">
        {[
          ["Figma", "Pia, Jonas, Lina", "1 ungenutzt"],
          ["Notion", "ganzes Team", "alle aktiv"],
          ["Adobe CC", "Mara, Tim", "2 ungenutzt"],
          ["Linear", "Jonas, Lina", "ok"],
        ].map(([t, u, s]) => (
  ...
  return (
    <div className="h-full w-full bg-white p-5 text-[#1F1D2B]" style={{ fontVariantNumeric: "tabular-nums" }}>
      ...
      <div className="mt-3 space-y-2 text-[12px]">
        {[
          ["EU Reverse-Charge", "1.842,00 €", "12 Belege"],
          ["Inland 19%", "2.103,00 €", "23 Belege"],
          ["Drittland", "412,00 €", "4 Belege"],
        ].map(([k, v, c]) => (
          <div key={k} className="flex items-center justify-between rounded-lg border border-[#1F1D2B]/10 px-3 py-2">
            <span className="font-medium">{k}</span>
      ...
      <div className="mt-4 rounded-xl bg-[#FBF7F1] p-3 text-[11px] text-[#1F1D2B]/70">
        Export als DATEV-CSV bereit. Reverse-Charge korrekt gekennzeichnet.
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-full w-full bg-white p-5 text-[#1F1D2B]" style={{ fontVariantNumeric: "tabular-nums" }}>
      ...
      <div className="mt-3 space-y-1.5 text-[12px]">
        {[
          ["Trello", "gekündigt 09/25", "−16 €/Mo"],
          ["Loom Business", "gekündigt 08/25", "−24 €/Mo"],
          ["Webflow CMS", "gekündigt 06/25", "−39 €/Mo"],
          ["Calendly Teams", "gekündigt 05/25", "−12 €/Mo"],
        ].map(([t, d, s]) => (
          <div key={t} className="flex items-center justify-between rounded-lg border border-[#1F1D2B]/10 px-3 py-2">
            ...
            <span className="text-[#12B76A] font-semibold">{s}</span>
          </div>
        ))}
      </div>
      <div className="mt-4 rounded-xl bg-[#12B76A]/10 p-3 text-[11px] text-[#12B76A] font-semibold">
        Eingespart insgesamt: 91 € / Monat
      </div>
    </div>
  );
}
...
export const audienceData: Record<AudienceSlug, AudienceData> = {
  agenturen: {
    ...
    subline:
      "Du betreust viele Kunden mit vielen Tools und weißt nicht, welche Kosten zu wem gehören. Toolfolio ordnet jedes Abo dem richtigen Kunden zu, zeigt deine Marge und macht die Weiterverrechnung zur Routine.",
    heroSlot: "Kosten nach Kunde",
    HeroPreview: PreviewKunde,
    situationLead:
      "Eine Agentur jongliert dreißig, fünfzig, hundert Tools über zehn oder zwanzig Kunden. Niemand weiß genau, welche Kosten zu welchem Projekt gehören. Die Weiterverrechnung passiert nach Bauchgefühl, Zugänge ausgeschiedener Mitarbeiter laufen still weiter und bezahlte Seats stehen leer.",
    pains: [
    ...
    features: [
      {
        title: "Toolkosten pro Kunde, mit echter Marge.",
        body: "Ordne jedes Abo dem richtigen Kunden zu. Toolfolio rechnet Kosten, Aufschlag und Marge pro Kunde aus. Du siehst sofort, wo du verdienst und wo du draufzahlst.",
        bullets: ["Drag-and-drop Zuordnung", "Aufschlag in % oder fix", "Marge pro Kunde live"],
        slot: "Kunden-Detail mit Marge",
        Preview: PreviewKunde,
        href: "/features/agentur-layer",
      },
      {
        title: "Weiterverrechnungs-Report, fertig für die Rechnung.",
        body: "Am Monatsende ein Klick. Du bekommst eine saubere Aufstellung pro Kunde, bereit zum Anhängen an die Rechnung oder zum Übernehmen in dein Faktura-Tool.",
        bullets: ["Pro Kunde gruppiert", "Reverse-Charge korrekt", "Export als PDF und CSV"],
        slot: "Report-Vorschau",
        Preview: PreviewReport,
        href: "/features/berichte",
      },
      {
        title: "Team, Seats und Offboarding ohne Lecks.",
        body: "Sieh, wer welches Tool wirklich nutzt. Hol ungenutzte Plätze zurück. Wenn jemand geht, weißt du auf einen Blick, welche Zugänge entzogen werden müssen.",
        bullets: ["Wer-nutzt-was Übersicht", "Inaktive Seats aufspüren", "Offboarding-Checkliste"],
        slot: "Seats und Nutzung",
        Preview: PreviewSeats,
        href: "/features/agentur-layer",
      },
      {
        title: "Benchmark: bei gleicher Leistung günstiger.",
        body: "Wir vergleichen deine Tools anonym mit dem Markt. Wenn du für die Leistung zu viel zahlst, schlagen wir konkret eine Alternative vor.",
        bullets: ["Anonymisierte Vergleichsdaten", "Konkrete Sparvorschläge", "Migrations-Hinweise"],
        slot: "Benchmark",
        Preview: PreviewBenchmark,
        href: "/features/benchmark",
      },
      {
        title: "Fristen-Wächter: keine stille Verlängerung.",
        body: "Bei dreißig Verträgen verpasst du Kündigungsfristen. Toolfolio warnt rechtzeitig, vor jeder Verlängerung, pro Kunde gruppiert.",
        bullets: ["Mehrstufige Warnungen", "Pro Kunde sortiert", "Kalender-Export"],
        slot: "Fristen-Übersicht",
        Preview: PreviewFristen,
        href: "/features/kuendigungsfristen-waechter",
      },
    ],
    outcomeBody:
      "Du siehst pro Kunde, wie viel Tool-Kosten reinkommen und wie viel rausgeht. Du hast eine saubere Grundlage für die Verhandlung des nächsten Retainers. Und du sparst dir das Excel am Monatsende.",
    outcomes: [
      { kpi: "+23%", label: "mehr Marge pro Kunde" },
      { kpi: "189 €", label: "Sparpotenzial pro Monat (Median)" },
      { kpi: "4 h", label: "weniger Excel pro Monat" },
    ],
    planName: "Agentur-Plan",
    planReason:
      "Der Agentur-Plan schaltet die Kunden-Zuordnung, Weiterverrechnungs-Reports und das Team-Offboarding frei. Genau das, was du brauchst, um Toolkosten in Marge zu verwandeln.",
    planPrice: "49 €",
    voices: [
  ...
  freelancer: {
    ...
    subline:
      "Du arbeitest mit zehn, zwanzig Tools und verlierst den Überblick. Toolfolio sammelt deine Abos, warnt vor Verlängerungen und liefert den Steuer-Export ohne Excel-Akrobatik.",
    heroSlot: "Dashboard für Freelancer",
    HeroPreview: PreviewDashboard,
    situationLead:
      "Als Freelancer trägst du alles selbst: Tool-Auswahl, Buchhaltung, Steuer. Du zahlst monatlich für Dinge, die du seit Wochen nicht mehr nutzt. Du verpasst Kündigungsfristen, weil sie nie an einem Ort stehen. Und am Quartalsende sammelst du Belege aus zehn Mail-Postfächern.",
    pains: [
    ...
    features: [
      {
        title: "Alle Abos auf einer Seite.",
        body: "Importiere per Mail-Forward, sieh alle Kosten, Verlängerungen und Kategorien an einem Ort. Endlich Überblick.",
        bullets: ["Mail-Forward-Import", "Auto-Kategorien", "Monats- und Jahressicht"],
        slot: "Dashboard",
        Preview: PreviewDashboard,
        href: "/features/ueberblick",
      },
      {
        title: "Fristen-Wächter gegen stille Verlängerung.",
        body: "Toolfolio warnt rechtzeitig vor jeder Verlängerung. Mehrstufig, im Kalender, per Mail. Du verpasst nichts mehr.",
        bullets: ["Warnungen 30/14/3 Tage vorher", "Kalender-Sync", "Schnelle Kündigung dokumentieren"],
        slot: "Fristen-Übersicht",
        Preview: PreviewFristen,
        href: "/features/kuendigungsfristen-waechter",
      },
      {
        title: "AI-Credits an einem Ort.",
        body: "ChatGPT, Claude, Midjourney. Toolfolio zeigt, wo wie viel Credit übrig ist und wann nachgeladen wird.",
        bullets: ["Multi-Provider", "Verbrauchstrend", "Warnung bei niedrigem Stand"],
        slot: "AI-Credits",
        Preview: PreviewAiCredits,
        href: "/features/ai-credits",
      },
      {
        title: "Steuer-Export ohne Excel.",
        body: "Ein Klick, du bekommst CSV oder DATEV-fertige Datei. Reverse-Charge korrekt gekennzeichnet, Belege verlinkt.",
        bullets: ["DATEV-Export", "Reverse-Charge automatisch", "Belege als PDF angehängt"],
        slot: "Steuer-Export",
        Preview: PreviewSteuer,
        href: "/features/steuer-export",
      },
      {
        title: "Archiv: was du gekündigt hast und was du sparst.",
        body: "Jede Kündigung landet im Archiv. Du siehst, was du im letzten Jahr eingespart hast, schwarz auf weiß.",
        bullets: ["Kündigungs-Historie", "Sparsumme pro Jahr", "Wiederaufnahme jederzeit"],
        slot: "Archiv",
        Preview: PreviewArchiv,
        href: "/features/archiv",
      },
    ],
    outcomeBody:
      "Keine vergessenen Abos mehr, keine verpassten Fristen, kein Steuer-Stress am Quartalsende. Du arbeitest, Toolfolio kümmert sich um den Rest.",
    outcomes: [
      { kpi: "127 €", label: "Sparen pro Monat (Median)" },
      { kpi: "0", label: "verpasste Fristen" },
      { kpi: "5 Min.", label: "Steuer-Export statt Stunden" },
    ],
    planName: "Pro-Plan",
    planReason:
      "Pro schaltet AI-Credits, Steuer-Export und unbegrenzte Abos frei. Genau das, was du als Freelancer brauchst, ohne Agentur-Overhead.",
    planPrice: "19 €",
    voices: [
  ...
  solopreneure: {
    ...
    subline:
      "Du baust dein Business alleine auf, jeder Euro zählt. Toolfolio zeigt, was du wirklich nutzt, stoppt vergessene Trials und schlägt Sparvarianten vor.",
    heroSlot: "Übersicht für Solopreneure",
    HeroPreview: PreviewDashboard,
    situationLead:
      "Du testest viel, abonnierst spontan, vergisst zu kündigen. Am Monatsende fragst du dich, wofür eigentlich die ganzen Abbuchungen waren. Vergessene Trials werden zu Dauer-Abos, und keiner sagt dir, dass es das gleiche Tool für die Hälfte gibt.",
    pains: [
    ...
    features: [
      {
        title: "Einfacher Überblick, ohne Setup.",
        body: "Mail-Forward einrichten, Toolfolio erkennt deine Abos automatisch. Nach fünf Minuten siehst du, wofür du jeden Monat zahlst.",
        bullets: ["Auto-Import via Mail", "Sortiert nach Kosten", "Monats- und Jahresblick"],
        slot: "Dashboard",
        Preview: PreviewDashboard,
        href: "/features/ueberblick",
      },
      {
        title: "Trial-Wächter: kein bezahltes Vergessen mehr.",
        body: "Toolfolio erkennt Trials und warnt dich vor dem Übergang in ein bezahltes Abo. Du entscheidest bewusst, statt zu zahlen weil du vergessen hast.",
        bullets: ["Trial-Erkennung", "Warnung 3 Tage vor Ablauf", "Direkt im Kalender"],
        slot: "Trial-Warnung",
        Preview: PreviewFristen,
        href: "/features/trial-erkennung",
      },
      {
        title: "Sparvorschläge: dasselbe für weniger.",
        body: "Wir schlagen Alternativen vor, die für dich genauso funktionieren, aber günstiger sind. Konkret, mit Migrations-Hinweis.",
        bullets: ["Anonymer Markt-Vergleich", "Konkrete Sparsumme", "Wechsel-Hinweise"],
        slot: "Sparvorschläge",
        Preview: PreviewSparvorschlaege,
        href: "/features/sparvorschlaege",
      },
      {
        title: "Archiv: das Spargedächtnis.",
        body: "Jede Kündigung wird festgehalten. Du siehst am Jahresende, was du wirklich eingespart hast.",
        bullets: ["Sparsumme pro Jahr", "Kündigungs-Historie", "Belege archiviert"],
        slot: "Archiv",
        Preview: PreviewArchiv,
        href: "/features/archiv",
      },
    ...
    outcomeBody:
      "Du behältst die Kontrolle, ohne ein zweites Excel zu führen. Du sparst echtes Geld, das du in dein Business stecken kannst. Und du schläfst nachts ruhiger.",
    outcomes: [
      { kpi: "89 €", label: "Sparen pro Monat (Median)" },
      { kpi: "0", label: "vergessene Trials" },
      { kpi: "5 Min.", label: "Setup, dann läuft es" },
    ],
    planName: "Free, dann Pro",
    planReason:
      "Starte komplett kostenlos. Wenn du mehr Abos verwalten oder den Steuer-Export brauchst, wechselst du in einem Klick zu Pro.",
    planPrice: "0 €",
    voices: [
