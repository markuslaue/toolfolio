...
export function spikeEmailHTML(props: SpikeEmailProps): string {
  const {
    ...
    sparseData = false,
    detailUrl = "https://toolfolio.lovable.app/ai-credits",
    thresholdUrl = "https://toolfolio.lovable.app/einstellungen/benachrichtigungen",
    acknowledgeUrl = "https://toolfolio.lovable.app/ai-credits",
