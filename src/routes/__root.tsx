...
import { ConsentProvider } from "@/components/marketing/consent-banner";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Behalte alle Software-Abos und wiederkehrenden Kosten deiner Agentur an einem Ort im Blick." },
      { name: "author", content: "Toolfolio" },
