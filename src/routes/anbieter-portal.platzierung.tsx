  ...
  return (
    <AnbieterPortalShell profile={profile}>
      <div className="max-w-2xl mx-auto py-16 text-center">
        ...
        <h1 className="mt-4 font-display text-3xl font-semibold tracking-tight">Platzierung</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Dieser Bereich folgt in Kürze (A-05). Hier buchst du optionale Premium-Sichtbarkeit, die
          immer transparent als gesponsert markiert wird. Die organische Position bleibt unabhängig.
        </p>
